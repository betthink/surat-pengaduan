          ...
          <div class="row justify-content-center container ">
              <div class="col-md-12">
                  <div class="mb-4">
                      ...
                      <p class="">Untuk warga yang belum terdaftar sihlakan registrasi</p>
                  </div>
                  <form class="row" action="" method="POST">
                      @csrf
                      <div class="form-group first col-md-4">
                      ...
                      <div class="invisible form-group first col-md-4">
                          <input value="public" name="status" type="text" class="form-control" required>
                      </div>
                      <button type="submit" class="btn text-white btn-block btn-secondary"> Datar </button>

                  </form>
              </div>
              <div class="mt-5">
                  <a class="text-primary" href="{{ route('public-login') }}">Login warga</a>
              </div>
          </div>
