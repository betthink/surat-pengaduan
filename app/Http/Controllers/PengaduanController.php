...
class PengaduanController extends Controller
{
    ...
    public function updateView(int $id)
    {
        ...
        return view('admin.pengaduan.update_pengaduan', ['title' => 'Halaman edit pengaduan', 'data' => $pengaduan]);
    }
    ...
    public function unduhPdf(int $id)
    {
        ...
        // $mpdfWriter = IOFactory::createWriter($phpword, 'PDF');
        // // Output PDF ke file
        // $pdfPath = public_path('pdf/' . $filename . '.pdf');
        // $mpdfWriter->save($pdfPath);
